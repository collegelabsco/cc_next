...
<table width="975" border="0" cellpadding="0" cellspacing="0" bgcolor="#dddddd">
    ...
    <tr>
        <td height="40" class="subtitle22bb">Level 3 - Social Network Analysis</td>
    </tr>
    <tr>
        <td class="subtitle22b">
            <br><br>
            Given one user and his links try and get all users in the shortest possible time with the least amount of calls.
            <br>

            One API to get a user and his friends. you can assume everyone is linked to everyone else
