...
<table width="975" border="0" cellpadding="0" cellspacing="0" bgcolor="#dddddd">
    ...
    <tr>
        <td height="40" class="subtitle22bb">Level 2 - QAD (quick-and-dirty) BitTorrent</td>
    </tr>
    <tr>
        <td class="subtitle22b">
            <br><br>
            Reconstruct a huge bitmap by downloading parts from multiple sites. The challenge is to do it the fastest.
            <br><br>
        </td>
    </tr>
</table>
